...
def test_rootfs_manifest_computes_install_paths_under_app_files_rootfs():
    ...
    assert plan.marker_path == "/data/user/0/dev.chanwoo.androlinux/files/rootfs/debian-arm64/.alr-installed-bookworm-slim-2026-05"
    assert plan.asset_destinations == {
        "rootfs.tar.zst": "/data/user/0/dev.chanwoo.androlinux/files/rootfs/.downloads/debian-arm64/bookworm-slim-2026-05/rootfs.tar.zst"
    }
