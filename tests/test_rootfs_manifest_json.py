...
def test_load_rootfs_manifest_from_json_sample():
    ...
    assert manifest.version == "bookworm-slim-2026-05-gui-gpu-v87"
    assert manifest.assets[0].path == "tiny-rootfs.tar"
    assert manifest.assets[0].sha256 == "9ddee16a49e5abe8d714eb8e8ba4b4c31e10f3d578d0f7bbd07d31c87cbd35b9"
    assert manifest.assets[0].size_bytes == 36136960
