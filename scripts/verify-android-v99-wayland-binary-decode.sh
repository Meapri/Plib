...
require_log "wayland display binary messages=15"
require_log "wayland display binary bytes=308"
...
require_pkg "versionCode=99"
require_pkg "versionName=0.4.99-wayland-binary-decode"
