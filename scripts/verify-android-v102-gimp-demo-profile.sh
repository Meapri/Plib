...
require_log "ALR_GIMP_DEMO_PROFILE_ENV GDK_BACKEND=wayland WAYLAND_DISPLAY=alr-gimp-0"
require_log "ALR_GIMP_DEMO_BUNDLE_LOCK present=true package_count=246"
require_log "ALR_GIMP_DEMO_BINARY present=false path=/usr/bin/gimp"
require_log "ALR_GIMP_DEMO_NEXT_STEP install_debian_arm64_bundle_from_lock"
...
require_pkg "versionCode=102"
require_pkg "versionName=0.4.102-gimp-demo-profile"

printf '%s\n' "Android v102 GIMP demo profile verification passed."
