...
require_log "full gimp probe mode=skipped"
require_log "GIMP GTK WAYLAND PROBE EXECUTION: PASS"
require_log "GIMP GUI QUIT WAYLAND PROBE EXECUTION:"
require_log "GIMP GUI WAYLAND PROBE EXECUTION:"
require_log "GIMP GUI WAYLAND BLOCKER: FAST_VERIFIER_SKIPPED"
...
require_log "gimp gui quit wayland connected="
require_log "gimp gui quit wayland server globals="
require_log "gimp gui wayland connected="
require_log "gimp gui wayland blocker=fast-verifier-skipped"
require_log "gimp gui wayland server globals=wl_compositor,wl_shm,xdg_wm_base,wl_seat,wl_output"
