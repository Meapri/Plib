...
require_log "gimp gtk wayland server globals=wl_compositor,wl_shm,xdg_wm_base,wl_seat,wl_output,wl_subcompositor,wl_data_device_manager,gtk_shell1,zxdg_shell_v6"
...
require_log "gimp gtk wayland server shell roles=0"
...
require_log "gimp gtk window wayland server requests=18"
require_log "gimp gtk window wayland server globals=wl_compositor,wl_shm,xdg_wm_base,wl_seat,wl_output,wl_subcompositor,wl_data_device_manager,gtk_shell1,zxdg_shell_v6"
...
require_log "gimp gtk window wayland server shell roles=0"
...
require_log "gimp gdk surface wayland server requests=18"
require_log "gimp gdk surface wayland server globals=wl_compositor,wl_shm,xdg_wm_base,wl_seat,wl_output,wl_subcompositor,wl_data_device_manager,gtk_shell1,zxdg_shell_v6"
...
require_log "gimp gdk surface wayland server shell roles=0"
require_log "gimp gdk surface wayland server surface attaches=0"
require_log "gimp gdk surface wayland server surface commits=0"
...
require_log "gimp gui quit wayland server requests=18"
...
require_log "gimp gui quit wayland server shell roles=0"
